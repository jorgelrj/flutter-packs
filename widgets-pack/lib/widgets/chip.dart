              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    if (expandLabel) Expanded(child: child) else Flexible(child: child),
                    if (onDelete != null)
                      IconTheme(
                        data: IconTheme.of(context).copyWith(color: effectiveOnBackgroundColor),
                        child: InkWell(
                          onTap: onDelete,
                          child: deleteIcon ?? const Icon(Icons.close, size: 20),
                        ),
                      )
